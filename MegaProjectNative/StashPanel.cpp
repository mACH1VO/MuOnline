...
using namespace Ogre;
	...
	StashPanel::StashPanel(MyGUI::Widget* _parent)
	{
		initialiseByAttributes(this, _parent);
		this->mclose_buttonButton->eventMouseButtonClick += MyGUI::newDelegate(this, &StashPanel::mclose_eventMouseButtonClick);
	}
	...
	void StashPanel::mclose_eventMouseButtonClick(MyGUI::WidgetPtr _sender)
	{
		...
		msg->windowId = InventoryWindowsID::Vault;
