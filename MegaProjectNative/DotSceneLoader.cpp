...
{
	this->entityList = new std::vector<Ogre::Entity*>();
...
void DotSceneLoader::processGrassLayers(rapidxml::xml_node<>* XMLNode)
{
    ...
    Ogre::Camera* tempCam = mSceneMgr->getCamera("MainCamera");//mSceneMgr->createCamera("ThIsNamEShoUlDnOtExisT");
...
void DotSceneLoader::processEntity(rapidxml::xml_node<>* XMLNode, Ogre::SceneNode *pParent)
{
    ...
    try
    {
		...
		this->entityList->push_back(pEntity);
